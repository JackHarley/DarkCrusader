	...
	<table cellpadding="2" border="0">
		...
		{% for system in systems %}
			...
			{% else %}
				<tr>
			{% endif %}
				<td><a href="{% url /index.php/systems/system %}?name={{system.system_name}}">{{system.system_name}}</a></td>
				{% if exists hasAccessToScans %}
					<td>
				...
				{% endif %}
				<td><a href="{% url /index.php/factions/faction %}?name={{system.stats.faction|urlencode}}">{{system.stats.faction}}</a></td>
			</tr>
		{% endfor %}
	</table>
</p>
