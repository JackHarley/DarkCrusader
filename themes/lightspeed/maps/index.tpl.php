...
<p>
	...
	<ul>
		...
		{% if exists userCanAccessScans %}<li><a href="{% url /index.php/maps/good10resources/5 %}">Systems with Good Quality 10/hour Scans (not Food/Water) on a 1:5 Scale</a></li>{% endif %}
